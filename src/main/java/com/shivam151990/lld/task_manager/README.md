...
CRUD of Task
Create task with given properties
Task assignable to other user
Searching and filtering task based on different criteria
Mark task complete but always keep in memory (history keeping)
